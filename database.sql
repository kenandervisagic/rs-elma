...
DELETE FROM `events`;
INSERT INTO `events` (`event_id`, `active`, `approved`, `cancel_policy`, `description`, `event_date`, `event_name`, `event_time`, `max_tickets`, `ticket_price`, `category_id`, `location_id`, `organizer_id`, `subcategory_id`, `max_tickets_user`) VALUES
                                                                                                                                                                                                                                                         (52, b'1', b'1', b'0', 'Spektakularni koncert mega zvijezde.', '2024-10-30', 'Tea Tairovic', '20:00:00', 3000, 30, 7, 12, 7, 8, 2),
                                                                                                                                                                                                                                                         (55, b'1', b'1', b'1', 'Nezaboravan koncert jednog od najpoznatijih izvođača današnjice.', '2024-12-12', 'Koncert Zvicera - Ed Sheeran', '21:00:00', 3000, 70, 7, 15, 7, 8, 1),
                                                                                                                                                                                                                                                         (56, b'1', b'1', b'0', 'Veliki derbi sarajevskih timova.', '2025-01-27', 'Sarajevo vs. Željezničar', '14:00:00', 2000, 50, 5, 17, 7, 9, 3),
                                                                                                                                                                                                                                                         (57, b'1', b'1', b'0', 'Klasični balet u izvedbi renomiranog baletskog ansambla', '2024-12-22', 'Balet "Orašar"', '17:00:00', 550, 10, 8, 14, 7, 10, 2),
                                                                                                                                                                                                                                                         (58, b'1', b'1', b'1', 'Revijalni meč boksa u kojem učestvuju najpoznatiji bokseri iz regije.', '2024-11-19', 'Boks meč - Revijalni spektakl', '21:00:00', 1000, 20, 5, 11, 7, 12, 1),
                                                                                                                                                                                                                                                         (59, b'1', b'1', b'0', 'Izložba moderne umjetnosti s radovima poznatih umjetnika iz Balkana i Evrope.', '2024-11-22', 'Izložba - Moderna umjetnost', '13:00:00', 1000, 25, 6, 16, 7, 15, 2),
                                                                                                                                                                                                                                                         (60, b'1', b'1', b'1', 'Festival koji okuplja najpoznatije rock bendove Balkana.', '2025-02-21', 'Tuzlanski Rock Festival', '17:00:00', 2000, 50, 7, 11, 7, 8, 3);
...
DROP TABLE IF EXISTS `event_subcategories`;
...
DELETE FROM `event_subcategories`;
...
-- Dumping data for table ticket_reservation.sectors: ~0 rows (approximately)
DELETE FROM `sectors`;
